    ...
    >
      ...
      >
        ...
        <View style={styles.modalContent}>
          ...
          {showSuccessPopup && (
            <View style={successPopupStyles.overlay}>
              <View style={successPopupStyles.container}>
                <Text style={successPopupStyles.checkIcon}>✅</Text>
                <Text style={successPopupStyles.title}>Success!</Text>
                <Text style={successPopupStyles.message}>Address saved successfully!</Text>
              </View>
            </View>
          )}
        </View>
...
const successPopupStyles = StyleSheet.create({
  overlay: {
    position: "absolute",
    top: 0,
    left: 0,
